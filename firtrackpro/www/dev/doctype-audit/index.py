...
META_IGNORE = {"name","owner","creation","modified","modified_by","idx","docstatus","parent","parentfield","parenttype","amended_from","naming_series"}
...
def audit_doctype(dt):
    ...
    fields = frappe.get_all("DocField", filters={"parent":dt}, fields=["fieldname","fieldtype","options","label"])
    for f in fields:
        fn = f["fieldname"] or ""
        ft = f["fieldtype"] or ""
        op = f["options"] or ""
