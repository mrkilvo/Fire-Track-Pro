...
def _ensure_address_from_selection(address_json: str, property_name: str, property_customer: str | None) -> str:
    """
    ...
    if property_customer:
        doc.append("links", {
            "link_doctype": DOC_CUSTOMER,
            "link_name": property_customer
        })
