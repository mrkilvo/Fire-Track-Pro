			...
			try {
				...
				switch (((B = 0), n && (o = [o[0] & 2, n.value]), o[0])) {
					...
					default:
						if (
							((n = t.trys),
							!(n = n.length > 0 && n[n.length - 1]) && (o[0] === 6 || o[0] === 2))
						) {
							t = 0;
							continue;
						}
	...
	ra = function (e, A, t, r, B) {
		...
		switch (e.size) {
			case 0:
				e.shape === 0
					? (n = s =
							Math.min(Math.abs(A), Math.abs(A - r), Math.abs(t), Math.abs(t - B)))
					: e.shape === 1 &&
			...
			case 1:
				e.shape === 0
					? (n = s =
							Math.max(Math.abs(A), Math.abs(A - r), Math.abs(t), Math.abs(t - B)))
					: e.shape === 1 &&
	...
	Ai = {
		...
		parse: function (e, A) {
			return A.length === 1 && Xr(A[0], "none")
				...
				: sA(A).map(function (t) {
						for (
							var r = { color: wA.TRANSPARENT, offsetX: X, offsetY: X, blur: X },
								B = 0,
								n = 0;
							n < t.length;
							n++
				...
				if (
					...
					var n = r.contentWindow.document.documentElement
						...
						s = r.contentWindow.document.body
							? se(
									t,
									getComputedStyle(r.contentWindow.document.body).backgroundColor
							  )
							: wA.TRANSPARENT;
...
var Go = function (e, A) {
	...
	tQ = (function () {
		function e(A) {
			...
			h > 1 &&
				((n /= h), (s /= h), (a /= h), (o /= h), (g /= h), (w /= h), (c /= h), (C /= h));
			var F = r.width - a,
				K = r.height - w,
				p = r.width - g,
				d = r.height - C,
			...
			(A.prototype.renderTextWithLetterSpacing = function (t, r, B) {
				...
				if (r === 0) this.ctx.fillText(t.text, t.bounds.left, t.bounds.top + B);
					...
					s.reduce(function (i, a) {
						return (
							n.ctx.fillText(a, i, t.bounds.top + B), i + n.ctx.measureText(a).width
						);
					}, t.bounds.left);
				}
			}),
			...
			(A.prototype.renderSolidBorder = function (t, r, B) {
				return P(this, void 0, void 0, function () {
					return _(this, function (n) {
						return (
							this.path(rB(B, r)), (this.ctx.fillStyle = R(t)), this.ctx.fill(), [2]
						);
					});
				});
			}),
...
//# sourceMappingURL=html2canvas.esm-Ge7aVWlp.js.map
