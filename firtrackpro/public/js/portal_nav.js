...
(function () {
  ...
  ready(function () {
    ...
    [
      ...
      ctx.root.querySelectorAll(".nav-toggle").forEach(function (btn) {
        ...
        btn.addEventListener("click", function () {
          ...
          if (closed) {
            ...
            setTimeout(function(){ sub.classList.add("hidden"); }, 160);
        ...
        if (href && href === path) {
          ...
          while (p && p !== ctx.root) {
            if (p.classList && p.classList.contains("nav-sub")) {
              ...
              var t = ctx.root.querySelector('.nav-toggle[data-target="'+pid+'"]');
      ...
      function save(ctx){
        var open = Array.prototype.slice.call(ctx.root.querySelectorAll(".nav-sub"))
