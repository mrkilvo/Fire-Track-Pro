...
var FullCalendar = (function (e) {
		...
		for (n.__k = [], h = 0; h < t.length; h++)
			if (
				...
				O(e, g, (p = p || d), i, s, o, l, a, c),
					...
					(f = g.ref) &&
						p.ref != f &&
						(S || (S = []), p.ref && S.push(p.ref, null, g), S.push(f, g.__c || y, g)),
					null != y
						? (null == b && (b = y),
	...
	function I(e) {
		...
		if (e.__k)
			for (t = e.__k.length - 1; t >= 0; t--) if ((n = e.__k[t]) && (r = I(n))) return r;
		return null;
	}
				...
				if (
					...
					r.__c
						...
						: ("prototype" in _ && _.prototype.render
								? (t.__c = u = new _(b, E))
								: ((t.__c = u = new w(b, E)), (u.constructor = _), (u.render = B)),
						  S && S.sub(u),
						  (u.props = b),
						  u.state || (u.state = {}),
						  (u.context = E),
	...
	function W(e, t, r) {
		...
		if ((i = e.__k))
			for (s = 0; s < i.length; s++) i[s] && W(i[s], t, r || "function" != typeof e.type);
	...
	((ne.prototype = new w()).isPureReactComponent = !0),
	...
	((ae.prototype = new w()).__a = function (e) {
		var t = this,
			n = le(t.__v),
			r = t.o.get(e);
		return (
	...
	const Jt = { week: 3, separator: 9, omitZeroMinute: 9, meridiem: 9, omitCommas: 9 },
		Kt = {
			timeZoneName: 7,
			era: 6,
			year: 5,
	...
	class on {
		constructor(e) {
			...
			for (let i in e)
				if (i in Jt) {
					n[i] = e[i];
					Jt[i] < 9 && (r = Math.min(Jt[i], r));
				} else (t[i] = e[i]), i in Kt && (r = Math.min(Kt[i], r));
	...
	const fn = {
			...
			monthStartFormat: hn,
			handleCustomRendering: Cn,
			customRenderingMetaMap: Cn,
	...
	function In(e, t, n = {}) {
		if (e === t) return !0;
		for (let r in t) if (!(r in e) || !On(e[r], t[r], n[r])) return !1;
	...
	function Un(e) {
		...
		for (
			n.debounceRendering = function (e) {
				...
				j(g(Gn, {}), document.createElement("div"));
			r.length;
	...
	(zn.prototype.classes = {}),
		(zn.prototype.iconClasses = {}),
		(zn.prototype.baseIconClass = ""),
		(zn.prototype.iconOverridePrefix = "");
	class Gn extends w {
		render() {
			return g("div", {});
		}
	...
	const qn = Fn({});
	function Yn(e, t, n, r, i, s, o, l, a, c, d, u, h, f) {
		return {
			dateEnv: i,
			nowManager: s,
			options: n,
			...
			createScrollResponder: (e) => new Vn(e, d, ht(n.scrollTime), n.scrollTimeReset),
	...
	class Qn extends w {
		shouldComponentUpdate(e, t) {
			return !In(this.props, e, this.propEquality) || !In(this.state, t, this.stateEquality);
		}
		safeSetState(e) {
			In(this.state, Object.assign(Object.assign({}, this.state), e), this.stateEquality) ||
				this.setState(e);
		}
	}
	(Qn.addPropsEquality = function (e) {
		let t = Object.create(this.prototype.propEquality);
		Object.assign(t, e), (this.prototype.propEquality = t);
	}),
		(Qn.addStateEquality = function (e) {
			let t = Object.create(this.prototype.stateEquality);
			Object.assign(t, e), (this.prototype.stateEquality = t);
		}),
		(Qn.contextType = qn),
		(Qn.prototype.propEquality = {}),
		(Qn.prototype.stateEquality = {});
	class Zn extends Qn {}
	function Xn(e, t) {
		...
		constructor() {
			super(...arguments),
				...
				(this.handleEl = (e) => {
					...
					(t.customRenderingReplaces && Jn(n, t)) || this.updateElRef(e);
				}),
				(this.updateElRef = (e) => {
				...
				r &&
					i(
						Object.assign(
							...
							{ elClasses: (n.elClasses || []).filter(er) }
						)
					);
			}
		}
	...
	class nr extends w {
		constructor() {
			super(...arguments),
				(this.InnerContent = rr.bind(void 0, this)),
				(this.handleEl = (e) => {
					(this.el = e),
						this.props.elRef &&
		...
		render() {
			...
			return g(
				nr,
				{
					...
					elTag: e.elTag || "div",
					elAttrs: e.elAttrs,
					elClasses: [...sr(e.viewSpec), ...(e.elClasses || [])],
					elStyle: e.elStyle,
					renderProps: r,
	...
	function pr(e, t = ht(0)) {
		...
		return e.start && ((n = Pt(e.start)), r && r <= n && (r = xt(n, 1))), { start: n, end: r };
	}
	function gr(e) {
		let t = pr(e);
	...
	class vr {
		...
		build(e, t, n = !0) {
			...
			return (
				...
				(l = o),
				c.showNonCurrentDates || (l = ar(l, i.range)),
		...
		adjustActiveRange(e) {
			...
			return (
				n &&
					(vt(r) < 0 && ((s = Pt(s)), (s = t.add(s, r))),
					vt(i) > 1 && ((o = Pt(o)), (o = xt(o, -1)), (o = t.add(o, i)))),
				{ start: s, end: o }
			);
		}
		buildRangeFromDuration(e, t, n, r) {
			...
			return (
				vt(n) <= 1 &&
					this.isHiddenDay(i) &&
					((i = this.skipHiddenDays(i, t)), (i = Pt(i))),
				c(),
		...
		buildRangeFromDayCount(e, t, n) {
			let r,
				...
				o = 0,
				l = e;
			s && (l = i.startOf(l, s)), (l = Pt(l)), (l = this.skipHiddenDays(l, t)), (r = l);
			do {
	...
	function br(e, t, n) {
		...
		for (let e in o) {
			...
			if (n.recurringDef) {
				...
				let a = Sr(n, o, t, r, i.recurringTypes);
				for (let t of a) {
					let n = yr(e, { start: t, end: r.add(t, o) });
					l[n.instanceId] = n;
				}
			}
		}
	...
	function Sr(e, t, n, r, i) {
		...
		return e.allDay && (s = s.map(Pt)), s;
	}
	const Er = { id: String, groupId: String, title: String, url: String, interactive: Boolean },
		wr = { start: Cn, end: Cn, date: Cn, allDay: Boolean },
		Cr = Object.assign(Object.assign(Object.assign({}, Er), wr), { extendedProps: Cn });
	function Dr(e, t, n, r, i = Ar(n), s, o) {
		let { refined: l, extra: a } = Rr(e, n, i),
			c = (function (e, t) {
				let n = null;
				e && (n = e.defaultAllDay);
		...
		if (d) {
			let e = xr(l, a, t ? t.sourceId : "", d.allDay, Boolean(d.duration), n, s);
			return (
				(e.recurringDef = {
					typeId: d.typeId,
					typeData: d.typeData,
		...
		let u = (function (e, t, n, r) {
			...
			o && l && (l = Pt(l));
			s && ((c = s.marker), o && (c = Pt(c)), l && c <= l && (c = null));
			c
				? (a = !0)
				: r ||
		...
		if (u) {
			let e = xr(l, a, t ? t.sourceId : "", u.allDay, u.hasEnd, n, s),
				r = yr(e.defId, u.range, u.forcedStartTzo, u.forcedEndTzo);
			return (
	...
	function Rr(e, t, n = Ar(t)) {
		return wn(e, n);
	}
	function Ar(e) {
		return Object.assign(
			Object.assign(Object.assign({}, Nr), Cr),
	...
	function Tr(e, t, n, r, i, s) {
		let o = { defs: {}, instances: {} },
			l = Ar(n);
		for (let a of e) {
			let e = Dr(a, t, n, r, l, i, s);
			e && _r(e, o);
		}
		return o;
	}
	function _r(e, t = { defs: {}, instances: {} }) {
		return (
	...
	function Ur(e) {
		return Object.assign(
			Object.assign(Object.assign({}, Nr), Lr),
		...
		switch (t.type) {
			case "RECEIVE_EVENTS":
				return (function (e, t, n, r, i, s) {
					if (t && n === t.latestFetchId) {
						let n = Tr(Fr(i, t, s), t, s);
						return r && (n = br(n, r, s)), Ir(Yr(e, t.sourceId), n);
					}
					return e;
			...
			case "RESET_RAW_EVENTS":
				return (function (e, t, n, r, i) {
					...
					return br(Tr(Fr(n, t, i), t, i, !1, s, o), r, i);
			...
			case "RESET_EVENTS":
				return t.eventStore;
			case "MERGE_EVENTS":
				return Ir(e, t.eventStore);
			case "PREV":
			case "NEXT":
			case "CHANGE_DATE":
			case "CHANGE_VIEW_TYPE":
				return r ? br(e, r.activeRange, i) : e;
			case "REMOVE_EVENTS":
				return (function (e, t) {
	...
	function Fr(e, t, n) {
		...
		return i && (e = Vr(e, i)), r && (e = Vr(e, r)), e;
	}
	function Vr(e, t) {
		let n;
		if (t) {
	...
	function Jr(e, t) {
		...
		return (
			Object.assign(
				...
				((r = e),
				(i = t.dateEnv),
				Object.assign(Object.assign({}, xi(r.range, i, r.allDay)), { allDay: r.allDay }))
			),
			n
		);
	}
	function Kr(e, t, n) {
		...
		return (
			e
				? ((s = Pt(s)), (s = r.add(s, i.defaultAllDayEventDuration)))
	...
	function ei(e, t, n, r) {
		...
		for (let t in e.defs) {
			let o = e.defs[t];
			s.defs[t] = ti(o, i[t], n, r);
		}
		for (let t in e.instances) {
			let o = e.instances[t],
				l = s.defs[o.defId];
			s.instances[t] = ni(o, l, i[o.defId], n, r);
		}
		return s;
	}
	function ti(e, t, n, r) {
	...
	function ni(e, t, n, r, i) {
		...
		return (
			...
			l && (a.range = { start: a.range.start, end: Kr(t.allDay, a.range.start, i) }),
			t.allDay && (a.range = { start: Pt(a.range.start), end: Pt(a.range.end) }),
			a.range.end < a.range.start && (a.range.end = Kr(t.allDay, a.range.start, i)),
			a
		);
	}
	class ri {
	...
	class ii {
		...
		setProp(e, t) {
			...
			else if ("id" === e) (t = Er[e](t)), this.mutate({ standardProps: { publicId: t } });
			else if (e in Er) (t = Er[e](t)), this.mutate({ standardProps: { [e]: t } });
			else if (e in Nr) {
				let n = Nr[e](t);
				(n =
					"color" === e
		...
		setStart(e, t = {}) {
			let { dateEnv: n } = this._context,
				r = n.createMarker(e);
			if (r && this._instance) {
				let e = mr(this._instance.range.start, r, n, t.granularity);
				t.maintainDuration
		...
		setEnd(e, t = {}) {
			...
			if ((null == e || ((n = r.createMarker(e)), n)) && this._instance)
				if (n) {
					let e = mr(this._instance.range.end, n, r, t.granularity);
		...
		setDates(e, t, n = {}) {
			...
			if (o && (null == t || ((r = i.createMarker(t)), r)) && this._instance) {
				...
				!0 === n.allDay && (e = fr(e));
				let t = mr(e.start, o, i, n.granularity);
				if (r) {
					let o = mr(e.end, r, i, n.granularity);
					(a = o),
						(l = t).years === a.years &&
						l.months === a.months &&
						l.days === a.days &&
		...
		get source() {
			...
			return e
				? new ri(this._context, this._context.getCurrentData().eventSources[e])
				: null;
		}
		get start() {
	...
	function oi(e, t, n) {
		...
		for (let e in i) {
			let n = i[e],
				l = r[n.defId];
			n.instanceId !== o && s.push(new ii(t, l, n));
		}
		return s;
	}
	function li(e, t, n, r) {
	...
	function ui(e, t) {
		return xn(e, (e) => hi(e, t));
	}
	function hi(e, t) {
		let n = [];
		return t[""] && n.push(t[""]), t[e.defId] && n.push(t[e.defId]), n.push(e.ui), Br(n);
	}
	function fi(e, t) {
		let n = e.map(pi);
	...
	function yi(e, t, n, r, i, s, o) {
		...
		let f = h.range.start,
			...
			v = Pt(f).valueOf() === Pt(g).valueOf(),
			y = Pt(Tt(p, -1)).valueOf() === Pt(Tt(m, -1)).valueOf();
	...
	function wi(e, t) {
		...
		return (
			null == l &&
				((l = n.interactive), null == l && (l = Boolean(s.hasHandlers("eventClick")))),
			l
				? qe((e) => {
	...
	const Ci = { start: Cn, end: Cn, allDay: Boolean };
	function Di(e, t, n) {
		let r = (function (e, t) {
				let { refined: n, extra: r } = wn(e, Ci),
	...
	function Ai(e, t, n) {
		return Object.assign(Object.assign({}, xi(e, t, n)), { timeZone: t.timeZone });
	}
	function xi(e, t, n) {
		return {
			...
			fetch(t, r).then((e) => {
				if (e.ok)
					return e.json().then(
						(t) => [t, e],
						() => {
							throw new _i("Failure parsing JSON", e);
						}
					);
				throw new _i("Request failed", e);
			})
		);
	}
	let Mi;
	...
	class Oi extends Zn {
		...
		render() {
			...
			return Ii() || s.push("fc-liquid-hack"), e.children(s, i, r, n);
		}
		componentDidMount() {
		...
		computeTiming() {
			...
			if (
				...
				(e = r.dateEnv.startOf(i, n.unit)),
					(t = r.dateEnv.add(e, ht(1, n.unit)).valueOf() - i.valueOf());
			} else (e = i), (t = 6e4);
			return (
				(t = Math.min(864e5, t)), { state: { nowDate: e, todayRange: Bi(e) }, waitMs: t }
			);
		}
	...
	class ji {
		...
		select(e, t) {
			...
			let r = this.getCurrentData(),
				i = Di(n, r.dateEnv, ht({ days: 1 }));
			i && (this.dispatch({ type: "SELECT_DATES", selection: i }), $r(i, null, r));
		}
		unselect(e) {
			let t = this.getCurrentData();
			t.dateSelection &&
		...
		addEvent(e, t) {
			if (e instanceof ii) {
				...
				return (
					this.getCurrentData().eventStore.defs[t.defId] ||
						(this.dispatch({
							type: "ADD_EVENTS",
							eventStore: _r({ def: t, instance: n }),
						}),
			...
			if (i) {
				...
				return (
					this.dispatch({ type: "ADD_EVENTS", eventStore: _r(i) }),
					this.triggerEventAdd(e),
					e
				);
			}
		...
		triggerEventAdd(e) {
			...
			t.trigger("eventAdd", {
				...
				relatedEvents: [],
				revert: () => {
					this.dispatch({ type: "REMOVE_EVENTS", eventStore: si(e) });
				},
			});
		}
		getEventById(e) {
			...
			for (let i in n) {
				let s = n[i];
				if (s.publicId === e) {
					if (s.recurringDef) return new ii(t, s, null);
					for (let e in r) {
						let n = r[e];
						if (n.defId === s.defId) return new ii(t, s, n);
					}
				}
			}
			return null;
		...
		addEventSource(e) {
			...
			let n = zr(e, t);
			return n
				? (this.dispatch({ type: "ADD_EVENT_SOURCES", sources: [n] }), new ri(t, n))
				: null;
		}
	...
	function Zi(e, t, n, r) {
		return {
			dow: e.getUTCDay(),
			isDisabled: Boolean(r && (!r.activeRange || !hr(r.activeRange, e))),
			isOther: Boolean(r && !hr(r.currentRange, e)),
			isToday: Boolean(t && hr(t, e)),
	...
	class ms {
		...
		findInsertion(e) {
			...
			let h = -1;
			return (
				u < s && t[u] === o && (h = ws(n[u], e.span.end, vs)[0]),
				{
					touchingLevel: l,
					touchingLateral: a,
					touchingEntry: c,
	...
	class ks extends Zn {
		render() {
			let { dateEnv: e, options: t, theme: n, viewApi: r } = this.context,
				...
				u = e.toDate(s);
			e.namedTimeZoneImpl && (u = Tt(u, 36e5));
			let h = Object.assign(
	...
	class Os extends Zn {
		constructor() {
			super(...arguments), (this.createDayHeaderFormatter = Qt(Ps));
		}
		render() {
			let { context: e } = this,
	...
	class Ws {
		...
		_sliceBusinessHours(e, t, n, r, ...i) {
			return e ? this._sliceEventStore(br(e, Bs(t, Boolean(n)), r), {}, t, n, ...i).bg : [];
		}
		_sliceEventStore(e, t, n, r, ...i) {
			if (e) {
				let s = li(e, t, Bs(n, Boolean(r)), r);
		...
		_sliceInteraction(e, t, n, r, ...i) {
			if (!e) return null;
			let s = li(e.mutatedEvents, t, Bs(n, Boolean(r)), r);
			return {
		...
		_sliceDateSpan(e, t, n, r, i, ...s) {
			...
			if (l) {
				let t = (function (e, t, n) {
						let r = Rr({ editable: !1 }, n),
							i = xr(r.refined, r.extra, "", e.allDay, !0, n);
						return {
							def: i,
							ui: hi(i, t),
							instance: yr(i.defId, e.range),
							range: e.range,
							isStart: !0,
							isEnd: !0,
						};
	...
	function js(e, t, n) {
		...
		for (let e in r) if (!ur(t.validRange, r[e].range)) return !1;
		return zs({ eventDrag: e }, n);
	}
	function Ls(e, t, n) {
		return !!ur(t.validRange, e.range) && zs({ dateSelection: e }, n);
	}
	function zs(e, t) {
		...
		return (t.pluginHooks.isPropsValid || Us)(r, t);
	}
	function Us(e, t, n = {}, r) {
		return (
			!(
				...
				!(function (e, t, n, r) {
					let i = t.getCurrentData(),
						...
						l = o.defs,
						a = o.instances,
						c = ui(l, s.isEvent ? e.eventUiBases : { "": i.selectionConfig });
					r && (c = xn(c, r));
					let d =
							((p = e.eventStore),
					...
					for (let r in a) {
						let o = a[r],
							...
							g = c[o.defId],
							m = l[o.defId];
						if (!Gs(g.constraints, p, d, e.businessHours, t)) return !1;
						...
						for (let e in h) {
							...
							if (dr(p, n.range)) {
								...
								if (y && !y(new ii(t, u[n.defId], n), new ii(t, m, o))) return !1;
							}
						}
						let b = i.eventStore;
						for (let e of g.allows) {
							let i,
								...
								l = b.defs[m.defId],
								a = b.instances[r];
							if (((i = l ? new ii(t, l, a) : new ii(t, m)), !e(Jr(s, t), i)))
								return !1;
						}
					}
					return !0;
			...
			!(
				...
				!(function (e, t, n, r) {
					...
					r && (c = r(c));
					if (!Gs(c.constraints, a, i, e.businessHours, t)) return !1;
					...
					for (let e in o) {
						...
						if (dr(a, n.range)) {
							...
							if (u && !u(new ii(t, s[n.defId], n), null)) return !1;
						}
					}
					for (let e of c.allows) {
						let r = Object.assign(Object.assign({}, n), l);
						if (!e(Jr(r, t), null)) return !1;
					}
					return !0;
				})(e, t, n, r)
			)
	...
	function Gs(e, t, n, r, i) {
		for (let s of e) if (!qs(Fs(s, t, n, r, i), t)) return !1;
		return !0;
	}
	...
	function qs(e, t) {
		for (let n of e) if (ur(n, t)) return !0;
		return !1;
	}
	const Ys = /^(visible|hidden)$/;
	class Qs extends Zn {
		constructor() {
			super(...arguments),
				(this.handleEl = (e) => {
		...
		needsXScrolling() {
			if (Ys.test(this.props.overflowX)) return !1;
			let { el: e } = this,
		...
		needsYScrolling() {
			if (Ys.test(this.props.overflowY)) return !1;
			let { el: e } = this,
		...
		getXScrollbarWidth() {
			return Ys.test(this.props.overflowX) ? 0 : this.el.offsetHeight - this.el.clientHeight;
		}
		getYScrollbarWidth() {
			return Ys.test(this.props.overflowY) ? 0 : this.el.offsetWidth - this.el.clientWidth;
		}
	}
	class Zs {
		constructor(e) {
		...
		for (let r of e) {
			...
			for (let i = 0; i < e; i += 1)
				n.push(
					g("col", {
						style: {
							width: "shrink" === r.width ? no(t) : r.width || "",
							minWidth: r.minWidth || "",
						},
					})
				);
	...
	class co extends Zn {
		constructor() {
			super(...arguments),
				(this.processCols = Qt((e) => e, eo)),
				(this.renderMicroColGroup = Qt(to)),
				(this.scrollerRefs = new Zs()),
				(this.scrollerElRefs = new Zs(this._handleScrollerEl.bind(this))),
				(this.state = {
					shrinkWidth: null,
					forceYScrollbars: !1,
		...
		computeShrinkWidth() {
			return ro(this.props.cols) ? Xs(this.scrollerElRefs.getAll()) : 0;
		}
		computeScrollerDims() {
			let e = is(),
	...
	co.addStateEquality({ scrollerClientWidths: kn, scrollerClientHeights: kn });
	class uo extends Zn {
		constructor() {
			super(...arguments),
				(this.buildPublicEvent = Qt((e, t, n) => new ii(e, t, n))),
				(this.handleEl = (e) => {
					(this.el = e), Xn(this.props.elRef, e), e && ci(e, this.props.seg);
				});
		}
		render() {
			const { props: e, context: t } = this,
				...
				o = {
					...
					isDraggable: !e.disableDragging && gi(r, t),
					isStartResizable: !e.disableResizing && mi(r, t),
					isEndResizable: !e.disableResizing && vi(r),
			...
			return g(
				nr,
				{
					...
					elTag: e.elTag,
					elAttrs: e.elAttrs,
					elClasses: [...Si(o), ...r.eventRange.ui.classNames, ...(e.elClasses || [])],
					elStyle: e.elStyle,
					renderProps: o,
	...
	ho.addPropsEquality({ seg: kn });
	const po = (e) =>
			g(qn.Consumer, null, (t) => {
				let { options: n } = t,
	...
	class mo extends Zn {
		constructor() {
			super(...arguments), (this.refineRenderProps = Zt(yo));
		}
		render() {
			let { props: e, context: t } = this,
				{ options: n } = t,
	...
	function vo(e) {
		return Boolean(e.dayCellContent || Jn("dayCellContent", e));
	}
	function yo(e) {
		let { date: t, dateEnv: n, dateProfile: r, isMonthStart: i } = e,
			s = Zi(t, e.todayRange, null, r),
			o = e.showDayNumber ? n.format(t, i ? e.monthStartFormat : go) : "";
		return Object.assign(
			...
			return g(
				...
				(t, r, i) =>
					g(
						...
						vo(e) && g(t, { elTag: "div", elClasses: ["fc-more-popover-misc"] }),
						n.children
					)
			);
		}
					...
					Boolean(e.moreCnt) &&
						g(
							nr,
							{
								...
								defaultGenerator: e.defaultGenerator || xo,
	...
	function To(e) {
		...
		let { hiddenSegs: t } = e;
		return { start: _o(t), end: ((n = t), n.reduce(Mo).eventRange.range.end) };
		var n;
	}
	function _o(e) {
		return e.reduce(ko).eventRange.range.start;
	}
	function ko(e, t) {
	...
	var Io = {
		...
		EventImpl: ii,
		Interaction: Pi,
		MoreLinkContainer: Ao,
		NamedTimeZoneImpl: class {
			constructor(e) {
				this.timeZoneName = e;
			}
		},
		NowIndicatorContainer: po,
		NowTimer: Wi,
		PositionCache: ds,
		RefMap: Zs,
		ScrollController: hs,
		...
		computeVisibleDayRange: pr,
		config: Ds,
		constrainPoint: Gi,
		createDuration: ht,
		createEmptyEventStore: Mr,
		createEventInstance: yr,
		createEventUi: Wr,
		createFormatter: hn,
		diffDates: mr,
		diffDayAndTime: Mt,
		...
		elementMatches: Ie,
		enableCursor: Xe,
		eventTupleToStore: _r,
		filterHash: An,
		findDirectChildren: Pe,
		findElements: Oe,
		flexibleCompare: it,
		formatDayString: Ft,
		formatIsoMonthStr: Vt,
		formatIsoTimeString: qt,
		getAllowYScrolling: Js,
		getCanVGrowWithinCell: Ii,
		getClippingParents: cs,
		getDateMeta: Zi,
		getDayClassNames: Xi,
		getDefaultEventEnd: Kr,
		getElSeg: di,
		getEntrySpanEnd: vs,
		getEventTargetViaRoot: Be,
		getIsRtlScrollbarOnLeft: rs,
		getRectCenter: Fi,
		getRelevantEvents: kr,
		getScrollGridClassNames: io,
		getScrollbarWidths: is,
		getSectionClassNames: so,
		getSectionHasLiquidHeight: $s,
		getSegAnchorAttrs: wi,
		getSegMeta: bi,
		getSlotClassNames: $i,
		getStickyFooterScrollbar: ao,
		getStickyHeaderDates: lo,
		getUniqueDomId: Le,
		greatestDurationDenominator: wt,
		groupIntersectingEntries: bs,
		guid: Qe,
		hasBgRendering: ai,
		hasCustomDayCellContent: vo,
		hasShrinkWidth: ro,
		identity: Cn,
		injectStyles: Re,
		interactionSettingsStore: Hi,
		interactionSettingsToStore: Ni,
		intersectRanges: ar,
		intersectRects: zi,
		intersectSpans: Ss,
		isArraysEqual: Dt,
		isColPropsEqual: eo,
		isDateSelectionValid: Ls,
		isDateSpansEqual: Ri,
		isInt: at,
		isInteractionValid: js,
		isMultiDayRange: gr,
		isPropsEqual: kn,
		isPropsValid: Us,
		isValidDate: zt,
		...
		renderFill: Eo,
		renderMicroColGroup: to,
		renderScrollShim: oo,
		requestJson: ki,
		sanitizeShrinkWidth: no,
		setRef: Xn,
		sliceEventStore: li,
		sortEventSegs: fi,
		startOfDay: Pt,
	...
	const Oo = [],
		...
		No = Object.assign(Object.assign({}, Po), {
			buttonHints: {
				prev: "Previous $0",
				next: "Next $0",
	...
	function qo(e) {
		return (t) =>
			g(qn.Consumer, null, (n) =>
				g(nr, {
					elTag: "div",
					elClasses: sr(n.viewSpec),
	...
	function Yo(e, t, n, r) {
		...
		return xn(
			(function (e, t) {
				let n,
					r = {};
				for (n in e) Go(n, r, e, t);
				for (n in t) Go(n, r, e, t);
				return r;
			})(i, s),
			(e) =>
				(function (e, t, n, r, i) {
	...
	function Xo(e, t, n, r) {
		...
		switch (t.type) {
			...
			case "FETCH_EVENT_SOURCES":
				return el(e, t.sourceIds ? Tn(t.sourceIds) : nl(e, r), i, t.isRefetch || !1, r);
			case "RECEIVE_EVENTS":
	...
	function al(e, t, n, r, i) {
		return {
			header: e.headerToolbar ? cl(e.headerToolbar, e, t, n, r, i) : null,
			footer: e.footerToolbar ? cl(e.footerToolbar, e, t, n, r, i) : null,
		};
	}
						...
						return r
							? (function (e, t, n, r, i) {
									...
									t &&
										(t.milliseconds < 0
											? (l = xt(l, 1))
											: t.milliseconds >= 864e5 && (o = xt(o, -1)));
									for (; o < l; ) {
										let e;
										(s && !s[o.getUTCDay()]) ||
											((e = t ? r.add(o, t) : o),
											a.push(r.createMarker(n.toDate(e)))),
											(o = xt(o, 1));
									}
									return a;
		...
		jo({
			...
			propSetHandlers: {
				...
				eventStore: function (e, t) {
					let { emitter: n } = t;
					n.hasHandlers("eventsSet") && n.trigger("eventsSet", oi(e, t));
				},
			},
		}),
	];
	...
	class vl {
		constructor(e) {
			(this.computeCurrentViewData = Qt(this._computeCurrentViewData)),
				(this.organizeRawLocales = Qt(Ho)),
				(this.buildLocale = Qt(Wo)),
				(this.buildPluginHooks = Lo()),
				(this.buildDateEnv = Qt(yl)),
				(this.buildTheme = Qt(bl)),
				(this.parseToolbars = Qt(al)),
				(this.buildViewSpecs = Qt(Yo)),
				(this.buildDateProfileGenerator = Zt(Sl)),
				(this.buildViewApi = Qt(El)),
				(this.buildViewUiProps = Zt(Dl)),
				(this.buildEventUiBySource = Qt(wl, kn)),
				(this.buildEventUiBases = Qt(Cl)),
				(this.parseContextBusinessHours = Zt(Al)),
				(this.buildTitle = Qt(gl)),
				(this.nowManager = new ml()),
				(this.emitter = new Qr()),
				(this.actionRunner = new pl(
			...
			let s = {
				...
				l = i.dateProfileGenerator.build(o);
			hr(l.activeRange, o) || (o = l.currentRange.start);
			for (let e of n.pluginHooks.contextInit) e(s);
			let a = Zo(n.calendarOptions, l, s),
				c = {
			...
			Rl(c, s) && this.emitter.trigger("loading", !0),
				(this.state = c),
				this.updateData(),
		...
		_handleAction(e) {
			...
			this.data &&
				...
				("PREV" !== e.type && "NEXT" !== e.type && hr(d.currentRange, c)) ||
					(c = d.currentRange.start);
			let u = Xo(n.eventSources, e, d, a),
				h = Gr(n.eventStore, e, u, d, a),
	...
	function yl(e, t, n, r, i, s, o, l) {
		let a = Wo(t || o.defaultCode, o.map);
		return new Ln({
	...
	function Al(e) {
		return Xr(e.options.businessHours, e);
	}
	function xl(e, t) {
	...
	class Tl extends Zn {
		...
		renderWidgetGroup(e) {
			...
			for (let s of e) {
				...
				if ("title" === e)
					(i = !1),
						r.push(g("h2", { className: "fc-toolbar-title", id: t.titleId }, t.title));
				else {
				...
				(this.handleSegClick = (e, t) => {
					...
					if (i && n.isValidSegDownEl(e.target)) {
						...
						r.emitter.trigger("eventClick", {
							el: t,
							event: new ii(n.context, i.eventRange.def, i.eventRange.instance),
							jsEvent: e,
							view: r.viewApi,
						}),
	...
	class Il extends Pi {
		constructor(e) {
			super(e),
				...
				(this.handleSegEnter = (e, t) => {
					di(t) && ((this.currentSegEl = t), this.triggerEvent("eventMouseEnter", e, t));
				}),
		...
		triggerEvent(e, t, n) {
			...
			(t && !r.isValidSegDownEl(t.target)) ||
				i.emitter.trigger(e, {
					el: n,
					event: new ii(i, s.eventRange.def, s.eventRange.instance),
					jsEvent: t,
					view: i.viewApi,
				});
		}
	...
	class Ol extends Qn {
		constructor() {
			super(...arguments),
				(this.buildViewContext = Qt(Yn)),
				(this.buildViewPropTransformers = Qt(Nl)),
			...
			return g(
				...
				g(Wi, { unit: "day" }, (r) => {
					...
					return g(
						...
						g(
							kl,
							{ liquid: i, height: s, aspectRatio: e, labeledById: l },
							this.renderView(t),
	...
	function Pl(e, t, n, r, i, s) {
		...
		return {
			...
			isTodayEnabled: o.isValid && !hr(t.currentRange, i),
	...
	function Hl(e) {
		let t = Wo(e.locale || "en", Ho([]).map);
		return new Ln(
			Object.assign(Object.assign({ timeZone: pn.timeZone, calendarSystem: "gregory" }, e), {
				locale: t,
			})
		);
	}
	...
	class Ll {
		...
		cleanup() {
			(jl = !1), (this.isDragging = !1), (this.subjectEl = null), this.destroyScrollWatch();
		}
		querySubjectEl(e) {
	...
	class Yl {
		...
		buildCaches(e) {
			return this.queryScrollEls(e).map((e) => (e === window ? new Vl(!1) : new Fl(e, !1)));
		}
		queryScrollEls(e) {
			let t = [];
	...
	class Zl {
		constructor(e) {
			(this.el = e),
				(this.origRect = as(e)),
				(this.scrollCaches = cs(e).map((e) => new Fl(e, !0)));
		}
		destroy() {
			for (let e of this.scrollCaches) e.destroy();
		}
		...
		isWithinClipping(e, t) {
			...
			for (let e of this.scrollCaches)
				if (!Xl(e.getEventTarget()) && !Li(n, e.clientRect)) return !1;
			return !0;
		}
	}
	function Xl(e) {
			...
			for (let s in n) {
				...
				if (l && l.isWithinClipping(e, t)) {
					...
					if (a >= 0 && a < u && c >= 0 && c < h) {
						...
						e &&
							ur(e.dateProfile.activeRange, e.dateSpan.range) &&
	...
	function Jl(e, t) {
		return (!e && !t) || (Boolean(e) === Boolean(t) && Ri(e.dateSpan, t.dateSpan));
	}
	function Kl(e, t) {
		let n = {};
		...
		constructor(e) {
			super(e),
				...
				(this.handlePointerDown = (e) => {
					...
					let l = (this.subjectSeg = di(e.subjectEl)),
						a = (this.eventRange = l.eventRange).instance.instanceId;
					(this.relevantEvents = kr(o.getCurrentData().eventStore, a)),
					...
					if (e) {
						...
						i === s || (t.editable && t.droppable)
							? ((o = (function (e, t, n, r) {
							  ...
							  o &&
									((l = ei(n, s.getCurrentData().eventUiBases, o, s)),
									(c.mutatedEvents = l),
									js(c, e.dateProfile, s) ||
										((a = !0),
										(o = null),
										(l = null),
			...
			let i = (this.hitDragging = new $l(this.dragging, Hi));
	...
	class ra {
		constructor(e, t) {
						...
						this.canDropElOnCalendar(n.subjectEl, i) &&
							((s = (function (e, t, n) {
								...
								let a = t.duration
										...
										: Kr(e.allDay, l, n),
									c = yr(o.defId, { start: l, end: a });
								return { def: o, instance: c };
							})(e.dateSpan, this.dragMeta, i)),
							(l.mutatedEvents = _r(s)),
							(o = !js(l, e.dateProfile, i)),
			...
			let n = (this.hitDragging = new $l(e, Hi));
			(n.requireInitial = !1),
		...
		componentInteractions: [
			class extends Pi {
				constructor(e) {
					...
					let t = (this.hitDragging = new $l(this.dragging, Ni(e)));
					t.emitter.on("pointerdown", this.handlePointerDown),
			...
			class extends Pi {
				constructor(e) {
						...
						(this.handleHitUpdate = (e, t) => {
							...
							if (e) {
								...
								(e.componentId === t.componentId &&
									...
									(r && Ls(r, e.dateProfile, n)) || ((i = !0), (r = null));
							}
							r
					...
					(r.touchScrollAllowed = !1),
						...
						(r.autoScroller.isEnabled = n.dragScroll);
					let i = (this.hitDragging = new $l(this.dragging, Ni(e)));
					i.emitter.on("pointerdown", this.handlePointerDown),
						i.emitter.on("dragstart", this.handleDragStart),
						i.emitter.on("hitupdate", this.handleHitUpdate),
						i.emitter.on("pointerup", this.handlePointerUp);
				...
				constructor(e) {
					super(e),
						...
						(this.handleHitUpdate = (e, t, n) => {
							...
							l &&
								((a = ei(i, r.getCurrentData().eventUiBases, l, r)),
								(d.mutatedEvents = a),
								js(d, e.dateProfile, r) ||
					...
					let r = (this.hitDragging = new $l(this.dragging, Ni(e)));
					...
					(this.context = e),
						...
						(this.onDocumentPointerDown = (e) => {
							...
							(this.matchesCancel = !!Me(n, t)),
								(this.matchesEvent = !!Me(n, ea.SELECTOR));
						}),
	...
	class oa extends gs {
		...
		renderHScrollLayout(e, t, n, r) {
			...
			let { props: s, context: o } = this,
				l = !s.forPrint && lo(o.options),
				a = !s.forPrint && ao(o.options),
				c = [];
			return (
				e &&
					c.push({
	...
	class fa extends Zn {
		render() {
			let { props: e, context: t } = this,
				{ options: n } = t,
				{ seg: r } = e,
				i = yi(r, n.eventTimeFormat || da, t, !0, e.defaultDisplayEventEnd);
			return g(
				uo,
				Object.assign({}, e, {
					elTag: "a",
			...
			return g(
				...
				(s, l) =>
					g(
						...
						!l.isDisabled && (t.showDayNumber || vo(i) || t.forceDayTop)
							? g(
									"div",
	...
	function Ca(e, t, n, r) {
		...
		let i = e.eventRange,
			s = i.range,
			o = ar(s, { start: r[t].date, end: xt(r[n - 1].date, 1) });
		return Object.assign(Object.assign({}, e), {
			firstCol: t,
			lastCol: n - 1,
			eventRange: {
	...
	class Ra extends gs {
		constructor() {
			super(...arguments),
				(this.cellElRefs = new Zs()),
				(this.frameElRefs = new Zs()),
				(this.fgElRefs = new Zs()),
				(this.segHarnessRefs = new Zs()),
				(this.rootElRef = { current: null }),
				...
				for (let o of e) {
					...
					s.push(
						g(
							...
							"bg-event" === t ? g(bo, Object.assign({ seg: o }, bi(o, r))) : Eo(t)
						)
					);
				}
			return g(v, {}, ...s);
	...
	function Ia(e, t) {
		...
		return new Hs(n, /year|month|week/.test(e.currentRangeUnit));
	}
	class Oa extends vr {
		buildRenderRange(e, t, n) {
	...
	class Ha extends Yi {
		...
		getKeysForEventDef(e) {
			return e.allDay ? (ai(e) ? ["timed", "allDay"] : ["allDay"]) : ["timed"];
		}
	}
	...
	class Ua extends gs {
		...
		renderHScrollLayout(e, t, n, r, i, s, o) {
			...
			let { context: a, props: c } = this,
				d = !c.forPrint && lo(a.options),
				u = !c.forPrint && ao(a.options),
				h = [];
			e &&
				h.push({
					type: "header",
	...
	class Fa {
		...
		computeDateTop(e, t) {
			return t || (t = Pt(e)), this.computeTimeTop(ht(e.valueOf() - t.valueOf()));
		}
		computeTimeTop(e) {
			let t,
				n,
	...
	class sc extends Zn {
		constructor() {
			super(...arguments), (this.sortEventSegs = Qt(fi));
		}
		render() {
			let { props: e, context: t } = this,
				{ options: n } = t,
			...
			return g(
				...
				(t) =>
					g(
						...
						vo(n) && g(t, { elTag: "div", elClasses: ["fc-timegrid-col-misc"] })
					)
			);
		}
			...
			let { props: n, context: r } = this,
				i = nc(e, n.date, n.slatCoords, r.options.eventMinHeight).map((r, i) => {
					...
					return g(
						...
						"bg-event" === t
							? g(bo, Object.assign({ seg: s }, bi(s, n.todayRange, n.nowDate)))
							: Eo(t)
					);
				});
			return g(v, null, i);
	...
	class hc extends gs {
		...
		render() {
			...
			return g(Wi, { unit: i ? "minute" : "day" }, (l, a) =>
				g(
					cc,
					Object.assign(
			...
			a =
				...
				(function (e) {
					...
					for (t = pc.length - 1; t >= 0; t -= 1)
						if (((n = ht(pc[t])), (r = Et(n, e)), null !== r && r > 1)) return n;
					return e;
				})(r),
			c = [];
		for (; St(o) < St(t); ) {
						...
						(function (e, t, n, r, i) {
							...
							if (!1 !== s.displayEventTime) {
								...
								if (
									(l.allDay
										? (c = !0)
										: gr(e.eventRange.range)
										? e.isStart
											? (o = yi(e, t, n, null, null, a.range.start, e.end))
											: e.isEnd
											? (o = yi(e, t, n, null, null, e.start, a.range.end))
											: (c = !0)
										: (o = yi(e, t, n)),
									c)
								) {
	...
	function _c(e, t, n, r, i) {
		...
		for (; l.valueOf() < o.valueOf(); ) {
			...
			let c = Pa({ currentRange: o, snapToWeek: !0, fixedWeekCount: r, dateEnv: n });
			c = { start: e.skipHiddenDays(c.start), end: e.skipHiddenDays(c.end, -1, !0) };
			const d = t.activeRange ? ar(t.activeRange, i ? c : o) : null;
			a.push({
	...
	const Nc = ["GPL-My-Project-Is-Open-Source", "CC-Attribution-NonCommercial-NoDerivatives"],
		Hc = {
			position: "absolute",
			zIndex: 99999,
			bottom: "1px",
		...
		viewContainerAppends: [
			function (e) {
				...
				if (!/\w+:\/\/fullcalendar\.io\/|\/examples\/[\w-]+\.html$/.test(n)) {
					let n = (function (e, t) {
						if (-1 !== Nc.indexOf(e)) return "valid";
		...
		return (
			...
			(Lc = (function () {
				...
				(n.style.width = "200px"),
					...
					e.scrollLeft > 0
						? (t = "positive")
						: ((e.scrollLeft = 1), (t = e.scrollLeft > 0 ? "reverse" : "negative"));
				return ke(e), t;
			})())
		);
	}
		...
		constructor() {
			super(...arguments),
				...
				(this.handleScroller = (e) => {
					(this.scroller = e), Xn(this.props.scrollerRef, e);
				}),
				(this.handleSizing = () => {
					let { props: e } = this;
						...
						Qs,
						{
							...
							maxHeight:
								"number" == typeof e.maxHeight
									? e.maxHeight + ("scroll-hidden" === l ? t.xScrollbarWidth : 0)
									: "",
							liquid: e.liquid,
							liquidIsAbsolute: !0,
						},
			...
			return (
				r.emitter.on("scroll", (r, i) => {
					if (
						...
						for (let r of t)
							r !== e &&
								(n ? (r.scrollTop = e.scrollTop) : (r.scrollLeft = e.scrollLeft));
				}),
	...
	class Yc extends Zn {
		constructor() {
			super(...arguments),
				...
				(this.renderMicroColGroups = Xt(to)),
				(this.clippedScrollerRefs = new Zs()),
				(this.scrollerElRefs = new Zs(this._handleScrollerEl.bind(this))),
				(this.chunkElRefs = new Zs(this._handleChunkEl.bind(this))),
			...
			return g(
				...
				(function (e, t) {
					let n = e.map((e, n) => {
						let r = e.width;
						return (
							"shrink" === r && (r = e.totalColWidth + no(t[n]) + 1),
							g("col", { style: { width: r } })
						);
					});
					return g("colgroup", {}, ...n);
		...
		renderChunk(e, t, n, r, i, s, o, l) {
			...
			return (
				...
				g(
					l ? "th" : "td",
					{ key: i.key, ref: this.chunkElRefs.createRef(f), role: "presentation" },
					D
				)
			);
		}
		...
		allowSizing() {
			...
			return !this.lastSizingDate ||
				e.valueOf() > this.lastSizingDate.valueOf() + Ds.SCROLLGRID_RESIZE_INTERVAL
	...
	function fd(e, t, n, r) {
		...
		let l = null;
		if (!i.isTimeScale) {
			const e = wt(i.slotDuration).unit;
		...
		return (
			...
			(i.cellRows = (function (e, t) {
				let n = e.slotDates,
					...
					l = r.map((e) => (e.getSmallestUnit ? e.getSmallestUnit() : null));
	...
	function pd(e, t, n) {
		let r = e;
		return t.isTimeScale || ((r = Pt(r)), t.largeUnit && (r = n.startOf(r, t.largeUnit))), r;
	}
	function gd(e, t, n, r) {
	...
	class Dd {
		constructor(e, t, n, r, i, s) {
			(this.slatRootEl = e),
				...
				(this.innerCoordCache = new ds(e, Pe(t, "div"), !0, !1));
		}
		isDateInRange(e) {
			return hr(this.dateProfile.currentRange, e);
		}
		dateToCoord(e) {
		...
		durationToCoord(e) {
			...
			if (t) {
				...
				n.isTimeScale || (o = Pt(o)), (s = this.dateToCoord(o)), !i && s && (s += 1);
			}
			return s;
		}
		coordFromLeft(e) {
	...
	class Td extends Zn {
		...
		render() {
			let { props: e, context: t } = this,
				{ unit: n, value: r } = wt(e.tDateProfile.slotDuration),
				i =
					e.slatCoords && e.slatCoords.dateProfile === e.dateProfile
						? e.slatCoords
						: null;
			return g(Wi, { unit: n, unitValue: r }, (n, r) =>
				g(
					"div",
						...
						g(
							...
							i &&
								...
								g(po, {
									...
									elStyle: Ad(i.dateToCoord(n), t.isRtl),
									isAxis: !0,
									date: n,
								})
						)
		...
		renderSegs(e, t, n) {
			let { todayRange: r, nowDate: i } = this.props,
				...
				l = e.map((e, t) => {
					...
					return g(
						"div",
						{ key: Ei(e.eventRange), className: "fc-timeline-bg-harness", style: l },
						"bg-event" === n ? g(bo, Object.assign({ seg: e }, bi(e, r, i))) : Eo(n)
					);
				});
			return g(v, null, l);
		}
	...
	class Pd extends Ws {
		sliceRange(e, t, n, r, i) {
			let s = (function (e, t, n) {
					if (!t.isTimeScale && ((e = pr(e)), t.largeUnit)) {
						let r = e;
						((e = {
	...
	const Nd = hn({ hour: "numeric", minute: "2-digit", omitZeroMinute: !0, meridiem: "narrow" });
	class Hd extends Zn {
		render() {
			let { props: e } = this;
			return g(
	...
	class Wd extends Zn {
		render() {
			...
			return g(
				...
				(e) =>
					g(e, { elTag: "div", elClasses: ["fc-timeline-more-link-inner", "fc-sticky"] })
			);
		}
	}
	class Bd extends Zn {
		constructor() {
			super(...arguments),
				(this.slicer = new Pd()),
				(this.sortEventSegs = Qt(fi)),
				(this.harnessElRefs = new Zs()),
				(this.moreElRefs = new Zs()),
	...
	class jd extends gs {
		...
		render() {
			let { props: e, state: t, context: n } = this,
				{ options: r } = n,
				{ dateProfile: i, tDateProfile: s } = e,
				{ unit: o, value: l } = wt(s.slotDuration);
			return g(
				"div",
				{
						...
						return (
							s &&
								c.push({
									...
									key: "footer",
									isSticky: !0,
									chunks: [{ key: "timeline", content: oo }],
								}),
							g(
								ir,
								{
	...
	function Gd(e, t = "", n, r) {
		let { refined: i, extra: s } = wn(e, Ud),
			o = {
				id: i.id || "_fc:" + Qe(),
				parentId: i.parentId || t,
				title: i.title || "",
				businessHours: i.businessHours ? Xr(i.businessHours, r) : null,
				ui: Wr(
					{
	...
	class Vd {
		...
		getEvents() {
			...
			for (let s in r) {
				let o = r[s],
					l = n[o.defId];
				-1 !== l.resourceIds.indexOf(e) && i.push(new ii(t, l, o));
			}
			return i;
		}
		get id() {
	...
	function fu(e, t) {
		...
		if (null == n) {
			...
			r && (n = r.extendedProps.resourceEditable),
				null == n &&
					((n = t.options.eventResourceEditable), null == n && (n = t.options.editable));
		}
		return n;
	}
	function pu(e, t, n, r) {
	...
	const xu = { resourceId: String, resourceIds: Cn, resourceEditable: Boolean };
	function Tu(e, t) {
	...
	const Mu = {
		...
		Iu = { resourcesSet: Cn, resourceAdd: Cn, resourceChange: Cn, resourceRemove: Cn };
	(ii.prototype.getResources = function () {
		let { calendarApi: e } = this._context;
		return this._def.resourceIds.map((t) => e.getResourceById(t));
	}),
		(ii.prototype.setResources = function (e) {
			let t = [];
			for (let n of e) {
				let e = null;
				"string" == typeof n
			...
			fetch(e, t, n) {
				const r = e.context.dateEnv,
					...
					s = e.range
						...
						: {};
				Ti(i.bind(null, s), (e) => t({ rawResources: e }), n);
			},
		}),
		yu({
			parseMeta: (e) =>
	...
	var Ou = jo({
		...
		reducers: [
			function (e, t, n) {
				let r = Cu(e && e.resourceSource, t, n);
				return {
					resourceSource: r,
				...
				if (
					(e &&
						...
						(r = Object.assign(Object.assign({}, r), {
							eventStore: Ir(n[""].eventStore, r.eventStore),
							eventUiBases: Object.assign(
								Object.assign({}, n[""].eventUiBases),
								r.eventUiBases
							),
						})),
					!Us(r, t, { resourceId: e }, Tu.bind(null, e)))
				)
					return !1;
			}
			return !0;
	...
	class ju extends gs {
		...
		render() {
			...
			return g(Wi, { unit: r.nowIndicator ? "minute" : "day" }, (t, n) =>
				g(
					cc,
	...
	class $u extends Zn {
		constructor() {
			super(...arguments),
				(this.resizerElRefs = new Zs(this._handleColResizerEl.bind(this))),
				(this.colDraggings = {});
		}
		render() {
	...
	class th extends Zn {
		constructor() {
			super(...arguments), (this.rootElRef = { current: null }), (this.rowElRefs = new Zs());
		}
		render() {
			let { props: e, context: t } = this;
			return g(
	...
	class nh extends gs {
		...
		render() {
			let { props: e, state: t, context: n } = this,
				...
				{ unit: s, value: o } = wt(i.slotDuration),
				l = this.computeHasResourceBusinessHours(e.rowNodes),
				...
				g(Wi, { unit: s, unitValue: o }, (t, s) =>
					g(
						...
						g(th, {
							...
							todayRange: s,
							splitProps: a,
							fallbackBusinessHours: l ? e.businessHours : null,
							clientWidth: e.clientWidth,
							minHeight: e.expandRows ? e.clientHeight : "",
							tableMinWidth: e.tableMinWidth,
						...
						n.options.nowIndicator &&
							...
							g(
								...
								g(po, {
									elClasses: ["fc-timeline-now-indicator-line"],
									elStyle: Ad(u.dateToCoord(t), n.isRtl),
									isAxis: !1,
									date: t,
								})
							)
				...
				(this.handleScrollRequest = (e) => {
					...
					if (t) {
						if (r) {
							...
							if (null != i) {
								let r =
									null != e.fromBottom ? t.bottoms[i] - e.fromBottom : t.tops[i];
	...
	return (
		fl.push(sa, Na, vc, Ac, Pc, id, ud, zd, Ou, Wu, zu, dh),
		...
		(e.ThirdPartyDraggable = class {
			constructor(e, t) {
				...
				"string" == typeof t.itemSelector
					...
					(new ra(r, t.eventData).hitDragging.disablePointCheck = !0);
			}
			destroy() {
				this.dragging.destroy();
			}
