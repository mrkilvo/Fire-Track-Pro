        ...
        return frappe._dict(
            {
                ...
                "logo": getattr(d, "logo", None)
                or "/assets/firtrackpro/images/firetrack-logo.png",
                "favicon": getattr(d, "favicon", None)
                or "/assets/firtrackpro/images/favicon.png",
                ...
                "support_email": getattr(d, "support_email", None)
                or "support@firetrackpro.com.au",
...
def list_or_demo(
    doctype, filters=None, fields=None, order_by=None, limit=None, demo=None
):
    try:
        if not frappe.db.has_table(doctype):
            return demo or []
        return frappe.get_all(
            doctype, filters or {}, fields or ["*"], order_by=order_by, limit=limit
        )
    except Exception:
        return demo or []
